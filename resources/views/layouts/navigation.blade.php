            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <span class="font-bold text-xl text-gray-800 dark:text-gray-200">Nómina</span>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-layout.dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        @else
                            <x-layout.dropdown-link :href="route('login')">
                                {{ __('Log In') }}
                            </x-layout.dropdown-link>
                        @endauth
                    </x-slot>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                @else
                    <x-layout.responsive-nav-link :href="route('login')">
                        {{ __('Log In') }}
                    </x-layout.responsive-nav-link>
                @endauth
            </div>
